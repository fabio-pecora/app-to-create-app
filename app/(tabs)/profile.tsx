...
export default function Profile(){
  ...
  return (
    <View style={{flex:1,backgroundColor:'#0f172a',padding:16}}>
      ...
      <TouchableOpacity onPress={async()=>{ await saveProfile({businessName,paymentMethod}); Alert.alert('Salvato','Profilo aggiornato');}} style={{backgroundColor:'#22c55e',padding:14,borderRadius:12,alignItems:'center'}}><Text style={{color:'white',fontWeight:'700'}}>Salva</Text></TouchableOpacity>
    </View>
  );
}
